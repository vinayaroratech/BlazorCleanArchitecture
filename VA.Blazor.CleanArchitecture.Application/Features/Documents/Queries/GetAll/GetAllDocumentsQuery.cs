...
namespace VA.Blazor.CleanArchitecture.Application.Features.Documents.Queries.GetAll
{
    ...
    internal class GetAllDocumentsQueryHandler : IRequestHandler<GetAllDocumentsQuery, PaginatedResult<GetAllDocumentsResponse>>
    {
        ...
        {
            Expression<Func<DocumentFile, GetAllDocumentsResponse>> expression = e => new GetAllDocumentsResponse
            {
                Id = e.Id,
                Title = e.Title,
            ...
            var data = await _unitOfWork.Repository<DocumentFile>().Entities
               .Specify(docSpec)
               .Select(expression)
