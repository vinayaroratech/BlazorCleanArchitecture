...
using VA.Blazor.CleanArchitecture.Application.Interfaces.Services.Account;
using VA.Blazor.CleanArchitecture.Application.Interfaces.Services.Identity;
using VA.Blazor.CleanArchitecture.Infrastructure;
...
using VA.Blazor.CleanArchitecture.Infrastructure.Repositories;
using VA.Blazor.CleanArchitecture.Infrastructure.Services;
using VA.Blazor.CleanArchitecture.Infrastructure.Services.Identity;
using VA.Blazor.CleanArchitecture.Infrastructure.Shared.Services;
using VA.Blazor.CleanArchitecture.Server.Localization;
using VA.Blazor.CleanArchitecture.Server.Managers.Preferences;
using VA.Blazor.CleanArchitecture.Server.Permission;
using VA.Blazor.CleanArchitecture.Server.Services;
using VA.Blazor.CleanArchitecture.Server.Settings;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(async c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\VA.Blazor.CleanArchitecture.Server.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "VA.Blazor.CleanArchitecture",
