...
using VA.Blazor.CleanArchitecture.Infrastructure.Helpers;
...
using VA.Blazor.CleanArchitecture.Shared.Constants.User;
...
namespace VA.Blazor.CleanArchitecture.Infrastructure
{
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                var superUser = new BlazorHeroUser
                {
                    FirstName = "Vinay",
                    LastName = "Arora",
                    Email = "vinay.arora@entasker.com",
                    UserName = "vinay",
                    EmailConfirmed = true,
